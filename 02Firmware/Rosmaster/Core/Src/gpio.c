...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOE, BIN1_Pin|BIN2_Pin|VGA_LED_Pin|VGA_DC_Pin
                          |VGA_RESET_Pin|VGA_CS_Pin|GREEDLED_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : BIN1_Pin BIN2_Pin VGA_LED_Pin VGA_DC_Pin
                           VGA_RESET_Pin VGA_CS_Pin GREEDLED_Pin */
  GPIO_InitStruct.Pin = BIN1_Pin|BIN2_Pin|VGA_LED_Pin|VGA_DC_Pin
                          |VGA_RESET_Pin|VGA_CS_Pin|GREEDLED_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
